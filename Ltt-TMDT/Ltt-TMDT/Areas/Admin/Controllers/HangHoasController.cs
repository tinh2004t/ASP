...
namespace Ltt_TMDT.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class HangHoasController : Controller
    {
        ...
        {
            var lttTmdtContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await lttTmdtContext.ToListAsync());
        }
        [Route("Details")]
