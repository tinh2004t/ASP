...
namespace Ltt_TMDT.Data;

public partial class LttTmdtContext : DbContext
{
    public LttTmdtContext()
    {
    }

    public LttTmdtContext(DbContextOptions<LttTmdtContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Server =LTTINH; Database=LttTMDT;Integrated Security=True;Trust Server Certificate=True");
